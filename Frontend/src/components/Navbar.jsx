    ...
    <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out" : ""}`}>
      <div className="navbar">
        <div className="navbar-start">
          ...
          <a className="text-2xl font-bold cursor-pointer hover:text-red-500">SD Store</a>
        </div>
        ...
        <div className="navbar-end space-x-2">
          ...
          </div>
          {
            authUser ? <Logout /> :
            <>
              <a className="bg-black text-white px-4 py-3 rounded-md hover:bg-red-800 duration-300 cursor-pointer"
               onClick={() => {
